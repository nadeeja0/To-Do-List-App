...
import 'package:flutter_firestore/utils.dart';
import 'package:flutter_firestore/widgets/date_selector.dart';
import 'package:flutter_firestore/widgets/task_card.dart';
                        ...
                        children: [
                           Expanded(
                            child: TaskCard(
                              ...
                              scheduledDate: snapshot.data!.docs[index].data()["postedAt"].toString(),
                            ),
                          ),
                          Container(
                            height: 50,
